...
function initialize() {
    var button = document.getElementById("fuel_consumption");
...
function showCars() {
    ...
    .then(function(cars) {
        ...
        for (var k = 0; k<cars.length; k++) {
            var car = cars[k];
            carlist += car.model + "     " + car.make + "     " + car.fuel_consumption + '<br>';
        }
        var car_fuel_list = document.getElementById("car_fuel_list")
